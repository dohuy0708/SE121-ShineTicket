      ...
      <table className="min-w-full border-collapse">
        <thead>
          <tr className="border-b">
            ...
            <th className="px-4 py-2 text-left">Nhà tổ chức</th>
            <th className="px-4 py-2 text-left">Số tiền thanh toán</th>
        ...
        <tbody>
          {invoices.map((invoice, index) => (
            <tr key={index} className="hover:bg-gray-50">
              ...
              <td className="px-4 py-2">{invoice.organizerName}</td>
              <td className="px-4 py-2">{invoice.amountPaid} VND</td>
