  ...
  return (
    <div className=" text-white p-4 rounded-lg space-y-4 mr-4">
      ...
      <div className="bg-bg-main p-4 rounded-lg">
        <h3 className="text-primary font-bold mb-2">Thông tin nhận vé</h3>
        <p>Lê Huy Hoàng 0987654321</p>
        <p>22520562@gm.uit.edu.vn</p>
        <button className="text-primary text-sm mt-2">Sửa thông tin</button>
      </div>
      <div className="bg-bg-main p-4 rounded-lg">
        <h3 className="text-primary font-bold mb-2">Phương thức thanh toán</h3>
